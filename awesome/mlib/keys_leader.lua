...
local web_keys = leader.bind_actions({
    ...
    {"I", with_wrapper.chromium(" --incognito https://hentaisun.com https://ohentai.org https://sukebei.nyaa.si/?f=0&c=1_1&q="), "echi"},
    ...
    {"t", with_wrapper.chromium_app("chrome-extension://dhdgffkkebhmkfjojejmpbldmpobfkfo/options.html#url=&nav=dashboard"), "tempermonkey"},
    ...
    {"a", with_wrapper.chromium("https://nyaa.si/?f=0&c=1_2&q=720 https://nyaa.si/?f=0&c=1_2&q=SubsPlease+720 https://anilist.co/search/anime?year=2023&season=WINTER https://anilist.co/search/anime?year=2022&season=FALL https://anilist.co/search/anime?airing%20status=RELEASING https://www.tokyotosho.info/search.php"),"anilist"},
    desc = "web_binds"
})
-- .............................................................
-- TODO XXX
...
local AwesomeKeysActions =  {
    ...
    {"a", function () mouse.screen.mywibox.visible = not mouse.screen.mywibox.visible end, "awm-wibar"},
...
for i = 1, 9 do
  ...
  local o = tonumber(i)
  AwesomeKeysActions[j] = {tostring(o)  , with_wrapper.shell("xcalib -c && xcalib -a -co " .. o .. "0")  , "xcalib-Contrast-Set_" .. o .. '0'}
end
local AwesomeKeys = {"a", leader.bind_actions( AwesomeKeysActions) , "WM" }

PrimaryLeader = leader.leader(
  leader.wrap(
    leader.repeat_count,
    leader.bind({
      ...
      {"k", kill_keys, 'KillAlls'},
        ...
        {"L", leader.action(function()
          ...
          awful.spawn.with_shell(terminal..' --title XSession --class M_SYS_LOG ' .. kit_opt_pad_small..kit_font_small..' tail -f ~/.xsession-errors')
          awful.spawn.with_shell(terminal..' --title Journal  --class M_SYS_LOG ' .. kit_opt_pad_small..kit_font_small..' journalctl -f')
