...
local function launch(key)
    w.visible = true
    awful.placement.top(w, { margins = {top = 80}, parent = awful.screen.focused()})
--   bg1 = colors.bg1,
--   bg2 = colors.xprpl,
--   col = '#000000',
--
    ...
    awful.prompt.run{
      prompt = "<span size='x-large' background='"..thm.wbg.."' color='#000000'> "
      .. item.ico.." " .. string.upper(item.label) .. " </span><span size='x-large' stretch='ultraexpanded' color='"..thm.wbg.."'></span> ",
      -- opacity = 0.2,
    -- fg = thm.bg_focus,
    -- bg = thm.bg_focus,
